                        ...
                        <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0 ">
                            <div className="lg:max-w-md">
                                ...
                                <p className="px-4 mb-10 text-base leading-7 text-gray-500 dark:text-gray-400">
                                    Welcome to ClassSync, your destination for innovative online learning!

                                    At ClassSync, we're passionate about breaking down barriers to education. Our platform connects learners with top-notch educators worldwide, offering engaging live classes, interactive tutorials, and collaborative study groups.

                                    Join our vibrant community today and embark on your learning journey with us!

                                    Welcome to the future of education. Welcome to ClassSync.
                                </p>
